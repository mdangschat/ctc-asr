...
def _generate_bucket_batch(sequence, seq_len, label, label_len, original, batch_size, capacity):
    ...
    if FLAGS.features_drop_every_second_frame:
        ...
        boundaries = [143, 154, 161, 168, 172, 179, 183, 186, 186, 193, 197, 203, 204, 208, 211,
                      211, 219, 222, 229, 229, 233, 237, 244, 247, 251, 255, 258, 264, 273, 276,
                      283, 294, 301, 311, 323, 337, 354, 376, 402, 435, 474, 523, 580, 647, 715,
                      778, 840, 909, 984, 1064, 1144, 1214, 1271, 1319, 1360, 1396, 1428, 1458,
                      1487, 1515, 1543, 1571, 1604]
