...
def _generate_bucket_batch(sequence, seq_len, label, label_len, original, batch_size, capacity):
    ...
    if FLAGS.features_drop_every_second_frame:
        boundaries = [71, 77, 80, 84, 86, 89, 91, 93, 93, 96, 98, 101, 102, 104, 105, 106, 109, 111,
                      114, 114, 116, 118, 122, 123, 125, 127, 129, 131, 136, 138, 141, 147, 150,
                      155, 161, 168, 176, 186, 200, 215, 236, 258, 287, 320, 354, 386, 417, 450,
                      487, 528, 568, 603, 633, 657, 678, 696, 712, 727, 742, 756, 770, 784, 800]

    else:
        boundaries = [143, 154, 161, 168, 172, 179, 183, 186, 186, 193, 197, 203, 204, 208, 211,
                      212, 219, 222, 229, 229, 233, 237, 244, 247, 251, 255, 258, 263, 273, 276,
                      283, 294, 300, 311, 323, 337, 353, 373, 400, 431, 472, 517, 575, 640, 708,
                      772, 834, 901, 975, 1056, 1136, 1207, 1266, 1315, 1357, 1393, 1425, 1455,
                      1484, 1512, 1540, 1568, 1600]
