...
def _generate_bucket_batch(sequence, seq_len, label, label_len, original, batch_size, capacity):
    ...
    if FLAGS.features_drop_every_second_frame:
        boundaries = [91, 105, 116, 125, 133, 141, 150, 158, 166, 174, 183, 192, 203, 213, 224, 235,
                      247, 260, 274, 288, 304, 321, 337, 354, 369, 384, 399, 414, 430, 446, 463,
                      481, 500, 519, 538, 557, 576, 594, 609, 623, 636, 648, 659, 670, 679, 688,
                      696, 704, 712, 719, 726, 733, 740, 747, 754, 760, 767, 773, 780, 787, 794,
                      804, 821]
    else:
        boundaries = [181, 210, 231, 249, 265, 282, 299, 315, 331, 347, 366, 384, 405, 426, 448,
                      469, 493, 520, 548, 576, 608, 641, 674, 707, 738, 768, 798, 827, 859, 891,
                      925, 962, 999, 1038, 1076, 1114, 1151, 1187, 1217, 1246, 1272, 1296, 1318,
                      1339, 1358, 1375, 1392, 1408, 1423, 1438, 1452, 1466, 1480, 1493, 1507, 1520,
                      1533, 1546, 1560, 1573, 1588, 1607, 1641]
