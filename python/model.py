...
class CTCModel(object):
    ...
    def inference(self, sequences, seq_length, training=True):
        """
    ...
    def loss_fn(self, logits, seq_length, labels):
        """
    ...
    def decode(self, logits, seq_len, originals=None):
        """
    ...
    def decoded_error_rates(self, labels, originals, decoded, decoded_texts):
        """
